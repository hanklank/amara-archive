...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.last_hidden_message_id'
        db.add_column('auth_customuser', 'last_hidden_message_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CustomUser.last_hidden_message_id'
        db.delete_column('auth_customuser', 'last_hidden_message_id')
    ...
    models = {
        'auth.amaraapikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'c70c0647e1b7fe23fb7a5ce085e148d71c8379bd'", 'max_length': '256', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'api_key'", 'unique': 'True', 'to': "orm['auth.CustomUser']"})
        },
        'auth.announcement': {
        ...
        'auth.customuser': {
            ...
            'last_hidden_message_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'blank': 'True'}),
